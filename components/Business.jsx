...
const Business = ({ url, name, entrepreneur, shortDesc, videos }) => {
  return (
    <Link href={`/${url}`} passHref>
      <div className="flex justify-between gap-4 bg-lightBackground hover:bg-middleBackground transition-colors duration-300 p-5 md:p-7 max-w-xs rounded-2xl cursor-pointer">
